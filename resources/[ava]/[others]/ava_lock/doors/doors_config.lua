...
ConfigDoors = {
    ...
    DoorList = {
        ...
        -- CLUCKIN
        {
            ...
            locked = true,
            doors = {
                {objHash = -1432609915, objYaw = 180.0, objCoords = vector3(-512.83, -683.73, 33.18)},
                {objHash = 903328250, objYaw = 180.0, objCoords = vector3(-510.5, -683.72, 33.18)},
            },
        },
        {
            objHash = -738011261,
        ...
        { -- main door
            ...
            locked = true,
            doors = {
                {objHash = 1519319655, objYaw = 58.5, objCoords = vector3(907.79, -159.61, 74.17)},
                {objHash = 1519319655, objYaw = 238.5, objCoords = vector3(906.27, -161.14, 74.17)},
            },
        },
        {
            ...
            locked = true,
            doors = {
                {objHash = -2023754432, objYaw = 58.5, objCoords = vector3(894.3, -180.0, 74.7)},
                {objHash = -2023754432, objYaw = 238.5, objCoords = vector3(894.7, -178.68, 74.7)},
            },
        },
        {
            objHash = -2023754432,
        ...
        { -- door to circuit
            ...
            distance = 30,
            doors = {
                {objHash = -348431101, objYaw = 190.0, objCoords = vector3(-2149.04, 1101.94, 28.66)},
                {objHash = 129720997, objYaw = 350.0, objCoords = vector3(-2149.11, 1109.94, 28.66)},
            },
        },
        { -- outside door
