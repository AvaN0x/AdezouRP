...
Config.Peds = {
    ...
    -- insurance office
    {
        ...
        PedType = "PED_TYPE_CIVFEMALE",
        pos = vector3(-707.93, 272.38, 81.67),
        -- pos = vector3(-708.0, 272.37, 81.67),
        scenario = "PROP_HUMAN_SEAT_BENCH",
        heading = 190.0,
        name = "Christine",
        bubble = "Bonjour, je vous laisse vous diriger vers le bureau au fond",
    },
    {
        PedName = "ig_barry",
        PedType = "PED_TYPE_CIVMALE",
        pos = vector3(-724.71, 264.21, 82.74),
        heading = 210.0,
        scenario = "PROP_HUMAN_SEAT_BENCH",
        name = "Barry",
