...
Config.Anims = {
    ...
    Bed = {
        Male = {dict = "switch@trevor@annoys_sunbathers", anim = "trev_annoys_sunbathers_loop_guy"},
        Female = {dict = "switch@trevor@annoys_sunbathers", anim = "trev_annoys_sunbathers_loop_guy"},
    },
}
