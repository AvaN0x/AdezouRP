...
Config.Jobs.winemaker = {
    ...
    SellZones = {
        WineMerchantSell = {
            Items = { { name = "winebox", price = 1400 }, { name = "grapejuicebox", price = 850 } },
        ...
        ChampagneMerchantSell = {
            Items = { { name = "champagnebox", price = 1500 }, { name = "luxurywinebox", price = 1500 } },
            Coord = vector3(-394.68, 208.51, 82.63),
            Size = { x = 1.5, y = 1.5, z = 1.5 },
            Color = { r = 252, g = 186, b = 3 },
            Name = "5. Vente des produits",
            HelpText = GetString("press_sell"),
