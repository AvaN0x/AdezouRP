...
-- These are added via another script, we need to wait for them to be available
Citizen.CreateThread(function()
    HardcodedLists["metal"] = {
        ...
        -- Credits to WildBrick142 at https://fr.gta5-mods.com/misc/chameleon-paint-add-on
        { value = 161, label = GetLabelText('ANOD_RED') },
        { value = 162, label = GetLabelText('ANOD_WINE') },
        { value = 163, label = GetLabelText('ANOD_PURPLE') },
        { value = 164, label = GetLabelText('ANOD_BLUE') },
        { value = 165, label = GetLabelText('ANOD_GREEN') },
        { value = 166, label = GetLabelText('ANOD_LIME') },
        { value = 167, label = GetLabelText('ANOD_COPPER') },
        { value = 168, label = GetLabelText('ANOD_BRONZE') },
        { value = 169, label = GetLabelText('ANOD_CHAMPAGNE') },
        { value = 170, label = GetLabelText('ANOD_GOLD') },
        { value = 171, label = GetLabelText('GREEN_BLUE_FLIP') },
        { value = 172, label = GetLabelText('GREEN_RED_FLIP') },
        { value = 173, label = GetLabelText('GREEN_BROW_FLIP') },
        { value = 174, label = GetLabelText('GREEN_TURQ_FLIP') },
        { value = 175, label = GetLabelText('GREEN_PURP_FLIP') },
        { value = 176, label = GetLabelText('TEAL_PURP_FLIP') },
        { value = 177, label = GetLabelText('TURQ_RED_FLIP') },
        { value = 178, label = GetLabelText('TURQ_PURP_FLIP') },
        { value = 179, label = GetLabelText('CYAN_PURP_FLIP') },
        { value = 180, label = GetLabelText('BLUE_PINK_FLIP') },
        { value = 181, label = GetLabelText('BLUE_GREEN_FLIP') },
        { value = 182, label = GetLabelText('PURP_RED_FLIP') },
        { value = 183, label = GetLabelText('PURP_GREEN_FLIP') },
        { value = 184, label = GetLabelText('MAGEN_GREE_FLIP') },
        { value = 185, label = GetLabelText('MAGEN_YELL_FLIP') },
        { value = 186, label = GetLabelText('BURG_GREEN_FLIP') },
        { value = 187, label = GetLabelText('MAGEN_CYAN_FLIP') },
        { value = 188, label = GetLabelText('COPPE_PURP_FLIP') },
        { value = 189, label = GetLabelText('MAGEN_ORAN_FLIP') },
        { value = 190, label = GetLabelText('RED_ORANGE_FLIP') },
        { value = 191, label = GetLabelText('ORANG_PURP_FLIP') },
        { value = 192, label = GetLabelText('ORANG_BLUE_FLIP') },
        { value = 193, label = GetLabelText('WHITE_PURP_FLIP') },
        { value = 194, label = GetLabelText('RED_RAINBO_FLIP') },
        { value = 195, label = GetLabelText('BLU_RAINBO_FLIP') },
        { value = 196, label = GetLabelText('DARKGREENPEARL') },
        { value = 197, label = GetLabelText('DARKTEALPEARL') },
        { value = 198, label = GetLabelText('DARKBLUEPEARL') },
        { value = 199, label = GetLabelText('DARKPURPLEPEARL') },
        { value = 200, label = GetLabelText('OIL_SLICK_PEARL') },
        { value = 201, label = GetLabelText('LIT_GREEN_PEARL') },
        { value = 202, label = GetLabelText('LIT_BLUE_PEARL') },
        { value = 203, label = GetLabelText('LIT_PURP_PEARL') },
        { value = 204, label = GetLabelText('LIT_PINK_PEARL') },
        { value = 205, label = GetLabelText('OFFWHITE_PRISMA') },
        { value = 206, label = GetLabelText('PINK_PEARL') },
        { value = 207, label = GetLabelText('YELLOW_PEARL') },
        { value = 208, label = GetLabelText('GREEN_PEARL') },
        { value = 209, label = GetLabelText('BLUE_PEARL') },
        { value = 210, label = GetLabelText('CREAM_PEARL') },
        { value = 211, label = GetLabelText('WHITE_PRISMA') },
        { value = 212, label = GetLabelText('GRAPHITE_PRISMA') },
        { value = 213, label = GetLabelText('DARKBLUEPRISMA') },
        { value = 214, label = GetLabelText('DARKPURPPRISMA') },
        { value = 215, label = GetLabelText('HOT_PINK_PRISMA') },
        { value = 216, label = GetLabelText('RED_PRISMA') },
        { value = 217, label = GetLabelText('GREEN_PRISMA') },
        { value = 218, label = GetLabelText('BLACK_PRISMA') },
        { value = 219, label = GetLabelText('OIL_SLIC_PRISMA') },
        { value = 220, label = GetLabelText('RAINBOW_PRISMA') },
        { value = 221, label = GetLabelText('BLACK_HOLO') },
        { value = 222, label = GetLabelText('WHITE_HOLO') },
        
        { value = 223, label = GetLabelText('YKTA_MONOCHROME') },
        { value = 236, label = GetLabelText('YKTA_CHROMABERA') },
        { value = 240, label = GetLabelText('YKTA_ELECTRO') },
        { value = 226, label = GetLabelText('YKTA_SPRUNK_EX') },
        { value = 239, label = GetLabelText('YKTA_HSW') },
        { value = 224, label = GetLabelText('YKTA_NITE_DAY') },
        { value = 233, label = GetLabelText('YKTA_SUNSETS') },
        { value = 227, label = GetLabelText('YKTA_VICE_CITY') },
        { value = 228, label = GetLabelText('YKTA_SYNTHWAVE') },
        { value = 225, label = GetLabelText('YKTA_VERLIERER2') },
        { value = 238, label = GetLabelText('YKTA_TEMPERATUR') },
        { value = 229, label = GetLabelText('YKTA_FOUR_SEASO') },
        { value = 234, label = GetLabelText('YKTA_THE_SEVEN') },
        { value = 230, label = GetLabelText('YKTA_M9_THROWBA') },
        { value = 231, label = GetLabelText('YKTA_BUBBLEGUM') },
        { value = 232, label = GetLabelText('YKTA_FULL_RBOW') },
        { value = 235, label = GetLabelText('YKTA_KAMENRIDER') },
        { value = 237, label = GetLabelText('YKTA_CHRISTMAS') },
        { value = 241, label = GetLabelText('YKTA_MONIKA') },
        { value = 242, label = GetLabelText('YKTA_FUBUKI') },
    }
end)
