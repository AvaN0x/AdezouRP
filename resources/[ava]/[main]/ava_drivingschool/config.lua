...
AVAConfig.DriverTest.Checkpoints = {
    ...
    { Coord = vector3(-833.66, 298.98, 85.28),
        MissionText = GetString("new_driving_speed_limit_residence", AVAConfig.DriverTest.Speeds["residence"]) },
    ...
    { Coord = vector3(2380.65, -242.99, 84.09),
        MissionText = GetString("new_driving_speed_limit_city", AVAConfig.DriverTest.Speeds["city"]) },
