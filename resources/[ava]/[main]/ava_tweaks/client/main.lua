...
local WeaponsToDisable = {
    ...
    -- [`VEHICLE_WEAPON_SEARCHLIGHT`] = true,
    -- [`VEHICLE_WEAPON_RADAR`] = true,
    ...
    -- [`VEHICLE_WEAPON_TURRET_INSURGENT`] = true,
    -- [`VEHICLE_WEAPON_PLAYER_SAVAGE`] = true,
    -- [`VEHICLE_WEAPON_TURRET_TECHNICAL`] = true,
    -- [`VEHICLE_WEAPON_NOSE_TURRET_VALKYRIE`] = true,
    -- [`VEHICLE_WEAPON_TURRET_VALKYRIE`] = true,
    [`VEHICLE_WEAPON_CANNON_BLAZER`] = true,
    -- [`VEHICLE_WEAPON_TURRET_BOXVILLE`] = true,
    -- [`VEHICLE_WEAPON_RUINER_BULLET`] = true,
    -- [`VEHICLE_WEAPON_RUINER_ROCKET`] = true,
    -- [`VEHICLE_WEAPON_HUNTER_MG`] = true,
    -- [`VEHICLE_WEAPON_HUNTER_MISSILE`] = true,
    -- [`VEHICLE_WEAPON_HUNTER_CANNON`] = true,
    -- [`VEHICLE_WEAPON_HUNTER_BARRAGE`] = true,
    -- [`VEHICLE_WEAPON_TULA_NOSEMG`] = true,
    -- [`VEHICLE_WEAPON_TULA_MG`] = true,
    -- [`VEHICLE_WEAPON_TULA_DUALMG`] = true,
    -- [`VEHICLE_WEAPON_TULA_MINIGUN`] = true,
    -- [`VEHICLE_WEAPON_SEABREEZE_MG`] = true,
    -- [`VEHICLE_WEAPON_MICROLIGHT_MG`] = true,
    -- [`VEHICLE_WEAPON_DOGFIGHTER_MG`] = true,
    -- [`VEHICLE_WEAPON_DOGFIGHTER_MISSILE`] = true,
    -- [`VEHICLE_WEAPON_MOGUL_NOSE`] = true,
    -- [`VEHICLE_WEAPON_MOGUL_DUALNOSE`] = true,
    -- [`VEHICLE_WEAPON_MOGUL_TURRET`] = true,
    -- [`VEHICLE_WEAPON_MOGUL_DUALTURRET`] = true,
    -- [`VEHICLE_WEAPON_ROGUE_MG`] = true,
    -- [`VEHICLE_WEAPON_ROGUE_CANNON`] = true,
    -- [`VEHICLE_WEAPON_ROGUE_MISSILE`] = true,
    -- [`VEHICLE_WEAPON_BOMBUSHKA_DUALMG`] = true,
    -- [`VEHICLE_WEAPON_BOMBUSHKA_CANNON`] = true,
    -- [`VEHICLE_WEAPON_HAVOK_MINIGUN`] = true,
    -- [`VEHICLE_WEAPON_VIGILANTE_MG`] = true,
    -- [`VEHICLE_WEAPON_VIGILANTE_MISSILE`] = true,
    -- [`VEHICLE_WEAPON_TURRET_LIMO`] = true,
    -- [`VEHICLE_WEAPON_DUNE_MG`] = true,
    -- [`VEHICLE_WEAPON_DUNE_GRENADELAUNCHER`] = true,
    -- [`VEHICLE_WEAPON_DUNE_MINIGUN`] = true,
    -- [`VEHICLE_WEAPON_TAMPA_MISSILE`] = true,
    -- [`VEHICLE_WEAPON_TAMPA_MORTAR`] = true,
    -- [`VEHICLE_WEAPON_TAMPA_FIXEDMINIGUN`] = true,
    -- [`VEHICLE_WEAPON_TAMPA_DUALMINIGUN`] = true,
    -- [`VEHICLE_WEAPON_HALFTRACK_DUALMG`] = true,
    -- [`VEHICLE_WEAPON_HALFTRACK_QUADMG`] = true,
    -- [`VEHICLE_WEAPON_APC_CANNON`] = true,
    -- [`VEHICLE_WEAPON_APC_MISSILE`] = true,
    -- [`VEHICLE_WEAPON_APC_MG`] = true,
    -- [`VEHICLE_WEAPON_ARDENT_MG`] = true,
    -- [`VEHICLE_WEAPON_TECHNICAL_MINIGUN`] = true,
    -- [`VEHICLE_WEAPON_INSURGENT_MINIGUN`] = true,
    -- [`VEHICLE_WEAPON_TRAILER_QUADMG`] = true,
    -- [`VEHICLE_WEAPON_TRAILER_MISSILE`] = true,
    -- [`VEHICLE_WEAPON_TRAILER_DUALAA`] = true,
    -- [`VEHICLE_WEAPON_NIGHTSHARK_MG`] = true,
    -- [`VEHICLE_WEAPON_OPPRESSOR_MG`] = true,
    -- [`VEHICLE_WEAPON_OPPRESSOR_MISSILE`] = true,
    -- [`VEHICLE_WEAPON_MOBILEOPS_CANNON`] = true,
    -- [`VEHICLE_WEAPON_AKULA_TURRET_SINGLE`] = true,
    -- [`VEHICLE_WEAPON_AKULA_MISSILE`] = true,
    -- [`VEHICLE_WEAPON_AKULA_TURRET_DUAL`] = true,
    -- [`VEHICLE_WEAPON_AKULA_MINIGUN`] = true,
    -- [`VEHICLE_WEAPON_AKULA_BARRAGE`] = true,
    -- [`VEHICLE_WEAPON_AVENGER_CANNON`] = true,
    -- [`VEHICLE_WEAPON_BARRAGE_TOP_MG`] = true,
    -- [`VEHICLE_WEAPON_BARRAGE_TOP_MINIGUN`] = true,
    -- [`VEHICLE_WEAPON_BARRAGE_REAR_MG`] = true,
    -- [`VEHICLE_WEAPON_BARRAGE_REAR_MINIGUN`] = true,
    -- [`VEHICLE_WEAPON_BARRAGE_REAR_GL`] = true,
    -- [`VEHICLE_WEAPON_CHERNO_MISSILE`] = true,
    -- [`VEHICLE_WEAPON_COMET_MG`] = true,
    -- [`VEHICLE_WEAPON_DELUXO_MG`] = true,
    -- [`VEHICLE_WEAPON_DELUXO_MISSILE`] = true,
    -- [`VEHICLE_WEAPON_KHANJALI_CANNON`] = true,
    -- [`VEHICLE_WEAPON_KHANJALI_CANNON_HEAVY`] = true,
    -- [`VEHICLE_WEAPON_KHANJALI_MG`] = true,
    -- [`VEHICLE_WEAPON_KHANJALI_GL`] = true,
    [`VEHICLE_WEAPON_REVOLTER_MG`] = true,
    -- [`VEHICLE_WEAPON_SAVESTRA_MG`] = true,
    [`VEHICLE_WEAPON_SUBCAR_MG`] = true, -- stromberg && toreador
    [`VEHICLE_WEAPON_SUBCAR_MISSILE`] = true, -- stromberg && toreador
    [`VEHICLE_WEAPON_SUBCAR_TORPEDO`] = true, -- stromberg && toreador
    -- [`VEHICLE_WEAPON_THRUSTER_MG`] = true,
    -- [`VEHICLE_WEAPON_THRUSTER_MISSILE`] = true,
    [`VEHICLE_WEAPON_VISERIS_MG`] = true,
    -- [`VEHICLE_WEAPON_VOLATOL_DUALMG`] = true,
    -- [`VEHICLE_WEAPON_WATER_CANNON`] = true,
    -- [1422046295] = true, -- water cannon
    [749486726] = true, -- paragon2 MG
    [231629074] = true, -- scramjet MG
    [-1125578533] = true, -- scramjet ROCKET
    [`VEHICLE_WEAPON_GRANGER2_MG`] = true, -- contract vehicles
}
