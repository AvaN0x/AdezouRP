...
function RageUI.PoolMenus:Example()
	...
	RightBadgesSubMenu:IsVisible(function(Items)
        ...
        Items:AddButton("Art", "RageUI.BadgeStyle.Art", { RightBadge = RageUI.BadgeStyle.Art, LeftBadge= RageUI.BadgeStyle.Art }, function(onSelected) end)
        Items:AddButton("Chips", "RageUI.BadgeStyle.Chips", { RightBadge = RageUI.BadgeStyle.Chips, LeftBadge= RageUI.BadgeStyle.Chips }, function(onSelected) end)
        ...
        Items:AddButton("Custom", "vehicle_card_icons_flag_france", { RightBadge = function() return {BadgeDictionary = "mpcarhud", BadgeTexture = "vehicle_card_icons_flag_france"} end }, function(onSelected) end)
        Items:AddButton("Custom", "vehicle_card_icons_acceleration", { RightBadge = function() return {BadgeDictionary = "mpcarhud", BadgeTexture = "vehicle_card_icons_acceleration"} end }, function(onSelected) end)
        Items:AddButton("Custom", "vehicle_card_icons_speed", { RightBadge = function() return {BadgeDictionary = "mpcarhud", BadgeTexture = "vehicle_card_icons_speed"} end }, function(onSelected) end)
        Items:AddButton("Custom", "vehicle_card_icons_flag_usa", { RightBadge = function() return {BadgeDictionary = "mpcarhud", BadgeTexture = "vehicle_card_icons_flag_usa"} end }, function(onSelected) end)
        Items:AddButton("Custom", "vehicle_card_icons_braking", { RightBadge = function() return {BadgeDictionary = "mpcarhud", BadgeTexture = "vehicle_card_icons_braking"} end }, function(onSelected) end)
        Items:AddButton("Custom", "transport_bicycle_icon", { RightBadge = function() return {BadgeDictionary = "mpcarhud", BadgeTexture = "transport_bicycle_icon"} end }, function(onSelected) end)
        Items:AddButton("Custom", "transport_bike_icon", { RightBadge = function() return {BadgeDictionary = "mpcarhud", BadgeTexture = "transport_bike_icon"} end }, function(onSelected) end)
        Items:AddButton("Custom", "transport_boat_icon", { RightBadge = function() return {BadgeDictionary = "mpcarhud", BadgeTexture = "transport_boat_icon"} end }, function(onSelected) end)
        Items:AddButton("Custom", "transport_car_icon", { RightBadge = function() return {BadgeDictionary = "mpcarhud", BadgeTexture = "transport_car_icon"} end }, function(onSelected) end)
        Items:AddButton("Custom", "transport_heli_icon", { RightBadge = function() return {BadgeDictionary = "mpcarhud", BadgeTexture = "transport_heli_icon"} end }, function(onSelected) end)
        Items:AddButton("Custom", "transport_plane_icon", { RightBadge = function() return {BadgeDictionary = "mpcarhud", BadgeTexture = "transport_plane_icon"} end }, function(onSelected) end)
        Items:AddButton("Custom", "common_medal", { RightBadge = function() return {BadgeDictionary = "commonmenu", BadgeTexture = "common_medal"} end }, function(onSelected) end)

        Items:AddButton("Custom", "leaderboard_audio_1", { RightBadge = function() return {BadgeDictionary = "mpleaderboard", BadgeTexture = "leaderboard_audio_1"} end }, function(onSelected) end)
        Items:AddButton("Custom", "leaderboard_audio_2", { RightBadge = function() return {BadgeDictionary = "mpleaderboard", BadgeTexture = "leaderboard_audio_2"} end }, function(onSelected) end)
        Items:AddButton("Custom", "leaderboard_audio_3", { RightBadge = function() return {BadgeDictionary = "mpleaderboard", BadgeTexture = "leaderboard_audio_3"} end }, function(onSelected) end)
        Items:AddButton("Custom", "leaderboard_audio_inactive", { RightBadge = function() return {BadgeDictionary = "mpleaderboard", BadgeTexture = "leaderboard_audio_inactive"} end }, function(onSelected) end)
        Items:AddButton("Custom", "leaderboard_audio_mute", { RightBadge = function() return {BadgeDictionary = "mpleaderboard", BadgeTexture = "leaderboard_audio_mute"} end }, function(onSelected) end)
        
        Items:AddButton("Custom", "leaderboard_female_icon", { RightBadge = function() return {BadgeDictionary = "mpleaderboard", BadgeTexture = "leaderboard_female_icon"} end }, function(onSelected) end)
        Items:AddButton("Custom", "leaderboard_male_icon", { RightBadge = function() return {BadgeDictionary = "mpleaderboard", BadgeTexture = "leaderboard_male_icon"} end }, function(onSelected) end)
        Items:AddButton("Custom", "leaderboard_deaths_icon", { RightBadge = function() return {BadgeDictionary = "mpleaderboard", BadgeTexture = "leaderboard_deaths_icon"} end }, function(onSelected) end)
        Items:AddButton("Custom", "leaderboard_globe_icon", { RightBadge = function() return {BadgeDictionary = "mpleaderboard", BadgeTexture = "leaderboard_globe_icon"} end }, function(onSelected) end)
        Items:AddButton("Custom", "leaderboard_kd_icon", { RightBadge = function() return {BadgeDictionary = "mpleaderboard", BadgeTexture = "leaderboard_kd_icon"} end }, function(onSelected) end)
        Items:AddButton("Custom", "leaderboard_players_icon", { RightBadge = function() return {BadgeDictionary = "mpleaderboard", BadgeTexture = "leaderboard_players_icon"} end }, function(onSelected) end)

        Items:AddButton("Custom", "rp", { RightBadge = function() return {BadgeDictionary = "mprpsymbol", BadgeTexture = "rp"} end }, function(onSelected) end)

        Items:AddButton("Custom", "w_am_fire_exting", { RightBadge = function() return {BadgeDictionary = "mpweaponsunusedfornow", BadgeTexture = "w_am_fire_exting"} end }, function(onSelected) end)
        Items:AddButton("Custom", "w_am_jerrycan", { RightBadge = function() return {BadgeDictionary = "mpweaponsunusedfornow", BadgeTexture = "w_am_jerrycan"} end }, function(onSelected) end)
        Items:AddButton("Custom", "w_am_loudhailer", { RightBadge = function() return {BadgeDictionary = "mpweaponsunusedfornow", BadgeTexture = "w_am_loudhailer"} end }, function(onSelected) end)
        Items:AddButton("Custom", "w_am_parachute", { RightBadge = function() return {BadgeDictionary = "mpweaponsunusedfornow", BadgeTexture = "w_am_parachute"} end }, function(onSelected) end)
        Items:AddButton("Custom", "w_ex_molotov", { RightBadge = function() return {BadgeDictionary = "mpweaponsunusedfornow", BadgeTexture = "w_ex_molotov"} end }, function(onSelected) end)
        Items:AddButton("Custom", "w_meleelasso_01", { RightBadge = function() return {BadgeDictionary = "mpweaponsunusedfornow", BadgeTexture = "w_meleelasso_01"} end }, function(onSelected) end)
        Items:AddButton("Custom", "w_me_bat", { RightBadge = function() return {BadgeDictionary = "mpweaponsunusedfornow", BadgeTexture = "w_me_bat"} end }, function(onSelected) end)
        Items:AddButton("Custom", "w_me_crowbar", { RightBadge = function() return {BadgeDictionary = "mpweaponsunusedfornow", BadgeTexture = "w_me_crowbar"} end }, function(onSelected) end)
        Items:AddButton("Custom", "w_me_fireaxe", { RightBadge = function() return {BadgeDictionary = "mpweaponsunusedfornow", BadgeTexture = "w_me_fireaxe"} end }, function(onSelected) end)
        Items:AddButton("Custom", "w_me_gclub", { RightBadge = function() return {BadgeDictionary = "mpweaponsunusedfornow", BadgeTexture = "w_me_gclub"} end }, function(onSelected) end)
        Items:AddButton("Custom", "w_me_hammer", { RightBadge = function() return {BadgeDictionary = "mpweaponsunusedfornow", BadgeTexture = "w_me_hammer"} end }, function(onSelected) end)
        Items:AddButton("Custom", "w_me_knife_01", { RightBadge = function() return {BadgeDictionary = "mpweaponsunusedfornow", BadgeTexture = "w_me_knife_01"} end }, function(onSelected) end)
        Items:AddButton("Custom", "w_me_nightstick", { RightBadge = function() return {BadgeDictionary = "mpweaponsunusedfornow", BadgeTexture = "w_me_nightstick"} end }, function(onSelected) end)
        Items:AddButton("Custom", "w_me_shovel", { RightBadge = function() return {BadgeDictionary = "mpweaponsunusedfornow", BadgeTexture = "w_me_shovel"} end }, function(onSelected) end)
        Items:AddButton("Custom", "w_me_wrench", { RightBadge = function() return {BadgeDictionary = "mpweaponsunusedfornow", BadgeTexture = "w_me_wrench"} end }, function(onSelected) end)
        Items:AddButton("Custom", "circle_checkpoints_cross", { RightBadge = function() return {BadgeDictionary = "cross", BadgeTexture = "circle_checkpoints_cross"} end }, function(onSelected) end)
        Items:AddButton("Custom", "timer_largecross_32", { RightBadge = function() return {BadgeDictionary = "crosstheline", BadgeTexture = "timer_largecross_32"} end }, function(onSelected) end)
        Items:AddButton("Custom", "timer_largetick_32", { RightBadge = function() return {BadgeDictionary = "crosstheline", BadgeTexture = "timer_largetick_32"} end }, function(onSelected) end)
