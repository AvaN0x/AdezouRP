...
ESX.Game.GetVehicleProperties = function(vehicle)
	...
	return {
		...
		modXenonColour    = GetVehicleXenonLightsColour(vehicle), -- edited by AvaN0x
...
ESX.Game.SetVehicleProperties = function(vehicle, props)
	...
	if props.modXenonColour ~= nil then -- edited by AvaN0x
		SetVehicleXenonLightsColour(vehicle, props.modXenonColour)
	end
