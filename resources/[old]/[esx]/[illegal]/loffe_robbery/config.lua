...
Config.Shops = {
    ...
    {coords = vector3(-3242.28, 999.72, 11.850),  heading = 354.8,   money = {5000, 15000}, cops = 8, cooldown = {hour = 0, minute = 30, second = 0},  robbed = false},
    {coords = vector3(549.4, 2671.39, 41.176),    heading = 96.5,    money = {5000, 15000}, cops = 8, cooldown = {hour = 0, minute = 30, second = 0},  robbed = false},
    {coords = vector3(1959.76, 3739.87, 31.363),  heading = 289.7,   money = {5000, 15000}, cops = 8, cooldown = {hour = 0, minute = 30, second = 0},  robbed = false},
    {coords = vector3(2677.86, 3279.12, 54.261),  heading = 332.8,   money = {5000, 15000}, cops = 8, cooldown = {hour = 0, minute = 30, second = 0},  robbed = false},
    {coords = vector3(1727.61, 6415.37, 34.057),  heading = 246.5,   money = {5000, 15000}, cops = 8, cooldown = {hour = 0, minute = 30, second = 0},  robbed = false},
    ...
    {coords = vector3(-2966.22, 390.79, 14.054),  heading = 87.0,    money = {5000, 15000}, cops = 8, cooldown = {hour = 0, minute = 30, second = 0},  robbed = false},
    {coords = vector3(1166.05, 2710.94, 37.167),  heading = 181.0,   money = {5000, 15000}, cops = 8, cooldown = {hour = 0, minute = 30, second = 0},  robbed = false},
    {coords = vector3(1392.39, 3606.44, 33.995),  heading = 203.0,   money = {5000, 15000}, cops = 8, cooldown = {hour = 0, minute = 30, second = 0},  robbed = false},
    ...
    {coords = vector3(1697.71, 4922.87, 41.08),   heading = 317.0,   money = {5000, 15000}, cops = 8, cooldown = {hour = 0, minute = 30, second = 0},  robbed = false},
