Locales['fr'] = {
  ...
  ['deposit_society_money_dirty']  = 'déposer argent sale',
  ...
  ['invalid_amount_max']     = 'Montant trop haut',
  ['no']                     = 'non',
  ['promote']                = 'promouvoir',
  ...
  ['withdraw_society_money_dirty'] = 'retirer argent sale',
  ['yes']                    = 'oui',
  ...
  ['open_action_bank'] = 'appuyez sur ~INPUT_CONTEXT~ pour gérer les fonds de l\'entreprise',
  ['action_bank'] = 'Gestion financière entreprise',
