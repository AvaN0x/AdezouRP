...
Citizen.CreateThread(function()
	...
	Citizen.CreateThread(function()
		while true do
			...
			elseif IsControlPressed(0, Keys['BACKSPACE']) and (GetGameTimer() - GUI.Time) > 150 then
				SendNUIMessage({
					action  = 'controlPressed',
					control = 'BACKSPACE'
				})
				...
				GUI.Time = GetGameTimer()
			elseif IsControlPressed(0, Keys['TOP']) and (GetGameTimer() - GUI.Time) > 150 then
				SendNUIMessage({
					action  = 'controlPressed',
					control = 'TOP'
				})
				...
				GUI.Time = GetGameTimer()
			elseif IsControlPressed(0, Keys['DOWN']) and (GetGameTimer() - GUI.Time) > 150 then
				SendNUIMessage({
					action  = 'controlPressed',
					control = 'DOWN'
				})
