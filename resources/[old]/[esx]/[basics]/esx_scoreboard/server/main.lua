...
AddEventHandler('esx:setJob', function(playerId, job, lastJob)
	connectedPlayers[playerId].job = job.name or ''
...
AddEventHandler('esx:setJob2', function(playerId, job2, lastJob)
	connectedPlayers[playerId].job2 = job2.name or ''
...
function AddPlayerToScoreboard(xPlayer, update)
	...
	connectedPlayers[playerId].job = xPlayer.job.name or ''
	connectedPlayers[playerId].job2 = xPlayer.job2.name or ''
