...
---@field mom number
---@field dad number
---@field face_md_weight number
---@field skin_md_weight number
---@field nose_1 number
---@field nose_2 number
---@field nose_3 number
---@field nose_4 number
---@field nose_5 number
---@field nose_6 number
---@field cheeks_1 number
---@field cheeks_2 number
---@field cheeks_3 number
---@field lip_thickness number
---@field jaw_1 number
---@field jaw_2 number
---@field chin_1 number
---@field chin_2 number
...
---@field hair_1 number
---@field hair_2 number
---@field hair_color_1 number
---@field hair_color_2 number
...
---@field mask_1 number
---@field mask_2 number
---@field bproof_1 number
---@field bproof_2 number
...
---@field watches_1 number
---@field watches_2 number
---@field bracelets_1 number
---@field bracelets_2 number
---@field bags_1 number
---@field bags_2 number
---@field eye_color number
---@field eye_squint number
---@field eyebrows_2 number
---@field eyebrows_1 number
---@field eyebrows_3 number
---@field eyebrows_4 number
---@field eyebrows_5 number
---@field eyebrows_6 number
---@field makeup_1 number
---@field makeup_2 number
---@field makeup_3 number
---@field makeup_4 number
---@field lipstick_1 number
---@field lipstick_2 number
---@field lipstick_3 number
---@field lipstick_4 number
---@field ears_1 number
---@field ears_2 number
---@field chest_1 number
---@field chest_2 number
---@field chest_3 number
---@field bodyb_1 number
---@field bodyb_2 number
---@field bodyb_3 number
---@field bodyb_4 number
---@field age_1 number
---@field age_2 number
---@field blemishes_1 number
---@field blemishes_2 number
---@field blush_1 number
---@field blush_2 number
---@field blush_3 number
---@field complexion_1 number
---@field complexion_2 number
---@field sun_1 number
---@field sun_2 number
---@field moles_1 number
---@field moles_2 number
---@field beard_1 number
---@field beard_2 number
---@field beard_3 number
---@field beard_4 number
local Character		= {}
