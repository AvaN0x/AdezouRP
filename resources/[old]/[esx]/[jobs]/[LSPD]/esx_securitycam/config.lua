...
Config.Locations = {
	...
	cityCamLabel = {label = _U('city')},
		cityCam = {
			{label = _U('ccam'), x = 215.88, y = -766.31, z = 34.80, r = {x = -25.0, y = 0.0, z = 228.05}, canRotate = true},
			{label = _U('ccam2'), x = 226.05, y = -1420.77, z = 40.40, r = {x = -30.0, y = 0.0, z = 100.29}, canRotate = true},
		},
	}
}
