Locales['fr'] = {
  ...
  ['nose_width'] = 'Nez : largeur',
  ['nose_height'] = 'Nez : hauteur',
  ['nose_peak'] = 'Nez : longueur',
  ['nose_bone'] = 'Nez : hauteur de l\'os',
  ['nose_peak_2'] = 'Nez : abaissement de la pointe',
  ['nose'] = 'Nez : Torsion',
  ['eyebrows_depth'] = 'Sourcils : hauteur',
  ['eyebrows_height'] = 'Sourcils : profondeur',
  ['cheekbones_height'] = 'Pommettes : horizontal',
  ['cheekbones_width'] = 'Pommettes : vertical',
  ['cheek_width'] = 'Joues : profondeur',
  ['opening_eyes'] = 'Ouverture des yeux',
  ['lips_thick'] = 'Epaisseur des lèvres',
  ['jaw_width'] = 'Mâchoire : largeur',
  ['jaw_length'] = 'Mâchoire : longueur',
  ['chin_height'] = 'Menton : hauteur',
  ['chin_lenght'] = 'Menton : longueur',
  ['chin_width'] = 'Menton : largeur',
  ['chin_hole'] = 'Menton : trou',
  ['neck_thick'] = 'Epaisseur du cou',
}
