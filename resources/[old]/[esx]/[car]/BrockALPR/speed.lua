...
Citizen.CreateThread( function()
	...
	while true do
		...
		if radar.shown  then
			...
			DrawRect(0.700, 0.94, 0.196, 0.116, 0, 0, 0, 150)
			DrawAdvancedText(0.793, 0.903, 0.005, 0.0028, 0.4, "Front Radar", 0, 191, 255, 255, 6, 0)
			DrawAdvancedText(0.793, 0.953, 0.005, 0.0028, 0.4, "Rear Radar", 0, 191, 255, 255, 6, 0)
			DrawAdvancedText(0.793, 0.928, 0.005, 0.0028, 0.4, radar.info, 255, 255, 255, 255, 6, 0)
			DrawAdvancedText(0.793, 0.979, 0.005, 0.0028, 0.4, radar.info2, 255, 255, 255, 255, 6, 0)
