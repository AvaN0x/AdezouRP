...
AddEventHandler('onMySQLReady', function ()
  ...
  MySQL.Async.execute( 'DELETE FROM `trunk_inventory` WHERE `plate` NOT IN (SELECT `plate` from `owned_vehicles`)', {})
...
ESX.RegisterServerCallback('esx_trunk_inventory:getItems',function(owner,cb)
  cb(arrayWeight)
end)
