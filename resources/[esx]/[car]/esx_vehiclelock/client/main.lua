					...
					local coords    = GetEntityCoords(playerPed, true)
 					...
 					local vehicleProps = ESX.Game.GetVehicleProperties(vehicle)
       				 ...
       				 if data3.current.value == 'donnerkey' then
						  ...
						  TriggerServerEvent('esx_vehiclelock:changeowner', GetPlayerServerId(player), data2.current.value)
...
function OpenCloseVehicle()
	...
	ESX.TriggerServerCallback('esx_vehiclelock:mykey', function(gotkey)
		...
		if gotkey or (jobName == "ambulance" and (vehicleName == "AMBULAN" or vehicleName == "dodgeEMS")) then
