...
TriggerEvent('es:addGroupCommand', 'r', 'admin', function(source, args, user)
    ...
    exports.esx_avan0x:SendWebhookEmbedMessage("avan0x_wh_staff_commands", "", GetPlayerName(source) .. " repared his/her vehicle", 15902015)
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
end, {help = "Repair vehicle", params = {}})

TriggerEvent('es:addGroupCommand', 'ra', 'admin', function(source, args, user)
	TriggerClientEvent('esx_ava_personalmenu:command:ra', source)
    exports.esx_avan0x:SendWebhookEmbedMessage("avan0x_wh_staff_commands", "", GetPlayerName(source) .. " revived all player near him/her", 15902015)
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
end, {help = "Repair vehicle", params = {}})

TriggerEvent('es:addGroupCommand', 'ava', 'superadmin', function(source, args, user)
	TriggerClientEvent('esx_ava_personalmenu:command:ava', source)
    exports.esx_avan0x:SendWebhookEmbedMessage("avan0x_wh_staff_commands", "", GetPlayerName(source) .. " used the ava **PINK** command", 15902015)
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
end, {help = "Repair vehicle", params = {}})