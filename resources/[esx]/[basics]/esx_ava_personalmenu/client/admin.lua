	...
	if PlayerGroup ~= nil and (PlayerGroup == "mod" or PlayerGroup == "admin" or PlayerGroup == "superadmin" or PlayerGroup == "owner") then
		...
		Citizen.CreateThread(function()
			while true do
				Citizen.Wait(3000)
				if show_hashes then
					-- todo choose which one to detect
					local playerPed = PlayerPedId()
					local playerCoords = GetEntityCoords(playerPed)
					visibleHash = {}
					...
					for _, v in ipairs(GetGamePool("CVehicle")) do
						...
						if GetDistanceBetweenCoords(playerCoords.x, playerCoords.y, playerCoords.z, vehCoords.x, vehCoords.y, vehCoords.z, false) < 10.0 then
					...
					for _, v in ipairs(GetGamePool("CPed")) do
						...
						if GetDistanceBetweenCoords(playerCoords.x, playerCoords.y, playerCoords.z, pedCoords.x, pedCoords.y, pedCoords.z, false) < 10.0 then
