...
function inventorySetup(items) {
    ...
    $.each(items, function (index, item) {
        ...
        $('#item-' + index).css("background-color", "rgba(0,0,0,0.2)");
        $('#item-' + index).css("border",  "solid black 1px");
        $('#item-' + index).css("border-radius",  "10px");
        $('#item-' + index).css("padding",  "5px");
...
function secondInventorySetup(items) {
    ...
    $.each(items, function (index, item) {
        ...
        $("#otherInventory").append('<div class="slot"><div id="itemOther-' + index + '" class="item" style = "background-image: url(\'img/items/' + item.name + '.png\')">' +
            '<div class="item-count">' + count + '</div> <div class="item-name">' + item.label + '</div> </div ><div class="item-name-bg"></div></div>');
        $('#itemOther-' + index).css("background-color", "rgba(0,0,0,0.2)");
        $('#itemOther-' + index).css("border",  "solid black 1px");
        $('#itemOther-' + index).css("border-radius",  "10px");
        $('#itemOther-' + index).css("padding",  "5px");    
