...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustReleased(0, Keys['L']) then
			...
			local entering = '{\"x\":'..pos.x..',\"y\":'..pos.y..',\"z\":'..(pos.z-0.98)..'}'
			local ipl = '[]'
			...
			if (GetOnscreenKeyboardResult()) then
				...
				if interieur == 1 then
					inside = '{"x":265.307,"y":-1002.802,"z":-99.99}'
					roommenu = '{"x":265.916,"y":-999.38,"z":-99.99}'
				...
				elseif interieur == 2 then
					...
					roommenu = '{"x":-622.173,"y":54.585,"z":96.62}'
				...
				elseif interieur == 3 then
					...
					roommenu = '{"x":-1457.026,"y":-530.219,"z":55.96}'
					price = math.random(price_high1,price_high1*1.55)
					isSingle = 1
					isRoom = 0
					name = 'HigApartment'..i
				elseif interieur == 4 then
					inside = '{"x":-682.2,"y":592.29,"z":144.392}'
					roommenu = '{"x":-680.46,"y":588.6,"z":136.79}'
					price = math.random(price_lux1,price_lux1*1.85)
					isSingle = 1
					isRoom = 0
					name = 'LuxApartment'..i
				elseif interieur == 5 then
					inside = '{"x":117.29,"y":559.53,"z":183.301}'
					roommenu = '{"x":118.748,"y":566.573,"z":175.72}'
				...
				elseif interieur == 6 then
					...
					roommenu = '{"x":-795.735,"y":326.757,"z":186.32}'
				...
				elseif interieur == 7 then
					inside = '{"x":151.45,"y":-1007.57,"z":-99.98}'
					roommenu = ''
					price = price_motel
					isSingle = 1
					isRoom = 1
				...
				TriggerServerEvent('putIn',name,label,entering,inside,ipl,isSingle,isRoom,0,roommenu,price)
				i = i + 1
			end
		end
	end
