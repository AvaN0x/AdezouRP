local hideValues = {
	mask_1 = {
		Male = {name = "mask_1", value = 0},
		Female = {name = "mask_1", value = 0}
	},
	helmet_1 = {
		Male = {name = "helmet_1", value = -1},
		Female = {name = "helmet_1", value = -1}
	},
	glasses_1 = {
		Male = {name = "glasses_1", value = 0},
		Female = {name = "glasses_1", value = 5}
	},
...
local Components = {
	...
	{label = _U('hair_1'),					name = 'hair_1',			value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.helmet_1}},
	{label = _U('hair_2'),					name = 'hair_2',			value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.helmet_1}},
	{label = _U('hair_color_1'),			name = 'hair_color_1',		value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.helmet_1}},
	{label = _U('hair_color_2'),			name = 'hair_color_2',		value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.helmet_1}},
	...
	{label = _U('eye_color'),				name = 'eye_color',			value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.helmet_1, hideValues.glasses_1}},
	{label = _U('eyebrow_size'),			name = 'eyebrows_2',		value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.helmet_1, hideValues.glasses_1}},
	{label = _U('eyebrow_type'),			name = 'eyebrows_1',		value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.helmet_1, hideValues.glasses_1}},
	{label = _U('eyebrow_color_1'),			name = 'eyebrows_3',		value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.helmet_1, hideValues.glasses_1}},
	{label = _U('eyebrow_color_2'),			name = 'eyebrows_4',		value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.helmet_1, hideValues.glasses_1}},
	{label = _U('makeup_type'),				name = 'makeup_1',			value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.helmet_1, hideValues.glasses_1}},
	{label = _U('makeup_thickness'),		name = 'makeup_2',			value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.helmet_1, hideValues.glasses_1}},
	{label = _U('makeup_color_1'),			name = 'makeup_3',			value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.helmet_1, hideValues.glasses_1}},
	{label = _U('makeup_color_2'),			name = 'makeup_4',			value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.helmet_1, hideValues.glasses_1}},
	{label = _U('lipstick_type'),			name = 'lipstick_1',		value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.helmet_1, hideValues.glasses_1}},
	{label = _U('lipstick_thickness'),		name = 'lipstick_2',		value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.helmet_1, hideValues.glasses_1}},
	{label = _U('lipstick_color_1'),		name = 'lipstick_3',		value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.helmet_1, hideValues.glasses_1}},
	{label = _U('lipstick_color_2'),		name = 'lipstick_4',		value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.helmet_1, hideValues.glasses_1}},
	...
	{label = _U('wrinkles'),				name = 'age_1',				value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.glasses_1}},
	{label = _U('wrinkle_thickness'),		name = 'age_2',				value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.glasses_1}},
	{label = _U('blemishes'),				name = 'blemishes_1',		value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.glasses_1}},
	{label = _U('blemishes_size'),			name = 'blemishes_2',		value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.glasses_1}},
	{label = _U('blush'),					name = 'blush_1',			value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.glasses_1}},
	{label = _U('blush_1'),					name = 'blush_2',			value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.glasses_1}},
	{label = _U('blush_color'),				name = 'blush_3',			value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.glasses_1}},
	{label = _U('complexion'),				name = 'complexion_1',		value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.glasses_1}},
	{label = _U('complexion_1'),			name = 'complexion_2',		value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.glasses_1}},
	{label = _U('sun'),						name = 'sun_1',				value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.glasses_1}},
	{label = _U('sun_1'),					name = 'sun_2',				value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.glasses_1}},
	{label = _U('freckles'),				name = 'moles_1',			value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.glasses_1}},
	{label = _U('freckles_1'),				name = 'moles_2',			value = 0,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65, 	hide = {hideValues.mask_1, hideValues.glasses_1}},
