Locales['fr'] = {
  ...
  ['turn_left_hway'] = 'Prenez à ~y~gauche~s~ et rentrez sur l\'autoroute',
  ['speed_limit'] = 'Vitesse limite: ~y~%s~s~ km/h',
  ['gratz_almost_end'] = 'Bravo, le test est presque terminé',
  ['turn_right'] = 'prenez à ~y~droite~s~',
