Config = {
    ...
    notify = {
        ...
        searching = 'Tu cherches des clients ~g~',
        abort = '~r~Le client a annulé la commande',
        notfound = '~r~Aucun client proche',
        approach = 'Ton client arrive',
        found = '~g~Tu as trouvé un client ~y~',
        press = 'Appuie sur ~INPUT_PICKUP~ pour ~y~sell',
        reject = '~r~Ce truc est merdique!',
