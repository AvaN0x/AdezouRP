...
AddEventHandler('KorioZ-PersonalMenu:Boss_promouvoirplayer', function(target, jobName)
	local _source = source
...
AddEventHandler('KorioZ-PersonalMenu:Boss_destituerplayer', function(target, jobName)
	local _source = source
...
AddEventHandler('KorioZ-PersonalMenu:Boss_virerplayer', function(target, jobName)
	local _source = source
...
AddEventHandler('KorioZ-PersonalMenu:Boss_promouvoirplayer2', function(target, jobName)
	local _source = source
...
AddEventHandler('KorioZ-PersonalMenu:Boss_destituerplayer2', function(target, jobName)
	local _source = source
...
AddEventHandler('KorioZ-PersonalMenu:Boss_virerplayer2', function(target, jobName)
	local _source = source
