...
local societymoney, societydirtymoney, societymoney2, societydirtymoney2 = nil, nil, nil, nil
...
AddEventHandler('esx_addonaccount:setMoney', function(society, money)
	if ESX.PlayerData.job ~= nil and ESX.PlayerData.job.grade_name == 'boss' and 'society_' .. ESX.PlayerData.job.name == society then
		UpdateSocietyMoney(money)
	elseif ESX.PlayerData.job ~= nil and ESX.PlayerData.job.grade_name == 'boss' and 'society_' .. ESX.PlayerData.job.name .. "_black" == society then 
		UpdateSocietyDirtyMoney(money)
	end
	if ESX.PlayerData.job2 ~= nil and ESX.PlayerData.job2.grade_name == 'boss' and 'society_' .. ESX.PlayerData.job2.name == society then
		UpdateSociety2Money(money)
	elseif ESX.PlayerData.job2 ~= nil and ESX.PlayerData.job2.grade_name == 'boss' and 'society_' .. ESX.PlayerData.job2.name .. "_black" == society then 
		UpdateSociety2DirtyMoney(money)
	end
end)
...
function UpdateSociety2DirtyMoney(money)
	societydirtymoney2 = ESX.Math.GroupDigits(money)
end
...
function admin_heal_player()
	...
	-- end
	if  plyId ~= nil then
		if GetPlayerName(tonumber(plyId)) ~= nil then
			TriggerServerEvent('esx_ambulancejob:revive2', tonumber( plyId))
		end
	else
		TriggerServerEvent('esx_ambulancejob:revive2', source)
	end
...
function changer_skin()
	...
	-- TriggerEvent('esx_skin:openSaveableRestrictedMenu', source,  -- aucune idée si fonctionnel
	-- {
	-- 	'tshirt_1',
	-- 	'tshirt_2',
	-- 	'torso_1',
...
function AddMenuDiversMenu(menu)
	...
	local DescriptionDrift = "Shift en conduisant pour drifter"
	...
	local driftMode = NativeUI.CreateItem(('Activer / Désactiver mode drift'), DescriptionDrift)
	DiversMenu.SubMenu:AddItem(driftMode)
...
function AddMenuBossMenu(menu)
	...
	local coffreItem, coffreDirtyItem = nil, nil
	...
	if societydirtymoney ~= nil and tonumber(societydirtymoney) > 0 then
		coffreDirtyItem = NativeUI.CreateItem(_U('bossmanagement_chest_button'), "")
		coffreDirtyItem:RightLabel("$" .. societydirtymoney)
		bossMenu.SubMenu:AddItem(coffreDirtyItem)
	end


    local job1Menu = _menuPool:AddSubMenu(bossMenu.SubMenu, "Métier principal")


		local recruterItem = NativeUI.CreateItem(_U('bossmanagement_hire_button'), "")
		job1Menu.SubMenu:AddItem(recruterItem)
		local virerItem = NativeUI.CreateItem(_U('bossmanagement_fire_button'), "")
		job1Menu.SubMenu:AddItem(virerItem)
		local promouvoirItem = NativeUI.CreateItem(_U('bossmanagement_promote_button'), "")
		job1Menu.SubMenu:AddItem(promouvoirItem)
		local destituerItem = NativeUI.CreateItem(_U('bossmanagement_demote_button'), "")
		job1Menu.SubMenu:AddItem(destituerItem)

		job1Menu.SubMenu.OnItemSelect = function(sender, item, index)
			...
			elseif item == virerItem then
				if ESX.PlayerData.job.grade_name == 'boss' then
					...
					if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
						...
						TriggerServerEvent('KorioZ-PersonalMenu:Boss_virerplayer', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job.name)
					end
				else
					notification("Entreprise", "Notification", _U('missing_rights'))
				end
			elseif item == promouvoirItem then
				if ESX.PlayerData.job.grade_name == 'boss' then
					...
					if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
						...
						TriggerServerEvent('KorioZ-PersonalMenu:Boss_promouvoirplayer', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job.name)
					end
				else
					notification("Entreprise", "Notification", _U('missing_rights'))
				end
			elseif item == destituerItem then
				if ESX.PlayerData.job.grade_name == 'boss' then
					...
					if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
						...
						TriggerServerEvent('KorioZ-PersonalMenu:Boss_destituerplayer', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job.name)
					end
				else
					notification("Entreprise", "Notification", _U('missing_rights'))
				end
			...
			if item == recruter2Item then
				if ESX.PlayerData.job.grade_name == 'boss' then
					...
					if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
						...
						TriggerServerEvent('KorioZ-PersonalMenu:Boss_recruterplayer2', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job.name, 0)
					end
				else
					notification("Entreprise", "Notification", _U('missing_rights'))
				end
			elseif item == virer2Item then
				if ESX.PlayerData.job.grade_name == 'boss' then
					...
					if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
						...
						TriggerServerEvent('KorioZ-PersonalMenu:Boss_virerplayer2', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job.name)
					end
				else
					notification("Entreprise", "Notification", _U('missing_rights'))
				end
			elseif item == promouvoir2Item then
				if ESX.PlayerData.job.grade_name == 'boss' then
					...
					if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
						...
						TriggerServerEvent('KorioZ-PersonalMenu:Boss_promouvoirplayer2', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job.name)
					end
				else
					notification("Entreprise", "Notification", _U('missing_rights'))
				end
			elseif item == destituer2Item then
				if ESX.PlayerData.job.grade_name == 'boss' then
					...
					if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
						...
						TriggerServerEvent('KorioZ-PersonalMenu:Boss_destituerplayer2', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job.name)
					end
				else
					notification("Entreprise", "Notification", _U('missing_rights'))
				end
...
function AddMenuBossMenu2(menu)
	...
	local coffre2Item, coffre2DirtyItem = nil, nil
	...
	if societydirtymoney2 ~= nil and tonumber(societydirtymoney2) > 0 then
		coffre2DirtyItem = NativeUI.CreateItem(_U('bossmanagement_chest_button'), "")
		coffre2DirtyItem:RightLabel("$" .. societydirtymoney2)
		bossMenu2.SubMenu:AddItem(coffre2DirtyItem)
	end

    local job1Menu = _menuPool:AddSubMenu(bossMenu2.SubMenu, "Métier principal")
			...
			if item == recruterItem then
				if ESX.PlayerData.job2.grade_name == 'boss' then
					...
					if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
						...
						TriggerServerEvent('KorioZ-PersonalMenu:Boss_recruterplayer', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job2.name, 0)
					end
				else
					notification("Entreprise", "Notification", _U('missing_rights'))
				end
			elseif item == virerItem then
				if ESX.PlayerData.job2.grade_name == 'boss' then
					...
					if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
						...
						TriggerServerEvent('KorioZ-PersonalMenu:Boss_virerplayer', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job2.name)
					end
				else
					notification("Entreprise", "Notification", _U('missing_rights'))
				end
			elseif item == promouvoirItem then
				if ESX.PlayerData.job2.grade_name == 'boss' then
					...
					if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
						...
						TriggerServerEvent('KorioZ-PersonalMenu:Boss_promouvoirplayer', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job2.name)
					end
				else
					notification("Entreprise", "Notification", _U('missing_rights'))
				end
			elseif item == destituerItem then
				if ESX.PlayerData.job2.grade_name == 'boss' then
					...
					if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
						...
						TriggerServerEvent('KorioZ-PersonalMenu:Boss_destituerplayer', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job2.name)
					end
				else
					notification("Entreprise", "Notification", _U('missing_rights'))
				end
	...
	local job2Menu = _menuPool:AddSubMenu(bossMenu2.SubMenu, "Métier secondaire")
			...
			elseif item == virer2Item then
				if ESX.PlayerData.job2.grade_name == 'boss' then
					...
					if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
						...
						TriggerServerEvent('KorioZ-PersonalMenu:Boss_virerplayer2', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job2.name)
					end
				else
					notification("Entreprise", "Notification", _U('missing_rights'))
				end
			elseif item == promouvoir2Item then
				if ESX.PlayerData.job2.grade_name == 'boss' then
					...
					if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
						...
						TriggerServerEvent('KorioZ-PersonalMenu:Boss_promouvoirplayer2', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job2.name)
					end
				else
					notification("Entreprise", "Notification", _U('missing_rights'))
				end
			elseif item == destituer2Item then
				if ESX.PlayerData.job2.grade_name == 'boss' then
					...
					if personalmenu.closestPlayer == -1 or personalmenu.closestDistance > 3.0 then
						...
						TriggerServerEvent('KorioZ-PersonalMenu:Boss_destituerplayer2', GetPlayerServerId(personalmenu.closestPlayer), ESX.PlayerData.job2.name)
					end
				else
					notification("Entreprise", "Notification", _U('missing_rights'))
				end
...
Citizen.CreateThread(function()
	while true do
		if IsControlJustReleased(0, Config.Menu.clavier) and (not isDead or (playerGroup ~= nil and (playerGroup == 'mod' or playerGroup == 'admin' or playerGroup == 'superadmin' or playerGroup == 'owner'))) then
