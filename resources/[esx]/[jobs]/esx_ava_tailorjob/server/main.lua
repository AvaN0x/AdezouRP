...
RegisterServerEvent('esx_ava_tailorjob:getStockItem')
AddEventHandler('esx_ava_tailorjob:getStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('esx_ava_tailorjob:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_ava_tailorjob:putStockItems')
AddEventHandler('esx_ava_tailorjob:putStockItems', function(itemName, count)
...
ESX.RegisterServerCallback('esx_ava_tailorjob:getPlayerInventory', function(source, cb)
...
ESX.RegisterServerCallback('esx_ava_tailorjob:canPickUp', function(source, cb, items)
	local xPlayer = ESX.GetPlayerFromId(source)
	local result = false
	for i=1, #items, 1 do
...
RegisterServerEvent('esx_ava_tailorjob:pickUp')
AddEventHandler('esx_ava_tailorjob:pickUp', function(item)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_ava_tailorjob:canprocess', function(source, cb, v)
...
RegisterServerEvent('esx_ava_tailorjob:process')
AddEventHandler('esx_ava_tailorjob:process', function(v)
...
RegisterServerEvent('esx_ava_tailorjob:cancelProcessing')
AddEventHandler('esx_ava_tailorjob:cancelProcessing', function()
...
RegisterNetEvent('esx_ava_tailorjob:SellItems')
AddEventHandler('esx_ava_tailorjob:SellItems', function(item,price,count) 
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_ava_tailorjob:GetSellElements', function(source, cb, items) 
	local xPlayer = ESX.GetPlayerFromId(source)
	while not xPlayer do 
		xPlayer = ESX.GetPlayerFromId(source); 
		Citizen.Wait(0); 
...
RegisterNetEvent('esx_ava_tailorjob:BuyItems')
AddEventHandler('esx_ava_tailorjob:BuyItems', function(item,price,count) 
	local xPlayer = ESX.GetPlayerFromId(source)
	while not xPlayer do 
		xPlayer = ESX.GetPlayerFromId(source); 
		Citizen.Wait(0); 
...
ESX.RegisterServerCallback('esx_ava_tailorjob:GetBuyElements', function(source, cb, items) 
	local xPlayer = ESX.GetPlayerFromId(source)
	while not xPlayer do 
		xPlayer = ESX.GetPlayerFromId(source); 
		Citizen.Wait(0); 
