...
TriggerEvent('esx_phone:registerNumber', Config.JobName, _U('vigneron_client'), true, true)
...
RegisterServerEvent('esx_ava_cluckinjob:getStockItem')
AddEventHandler('esx_ava_cluckinjob:getStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('esx_ava_cluckinjob:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_ava_cluckinjob:putStockItems')
AddEventHandler('esx_ava_cluckinjob:putStockItems', function(itemName, count)
...
ESX.RegisterServerCallback('esx_ava_cluckinjob:getPlayerInventory', function(source, cb)
...
ESX.RegisterServerCallback('esx_ava_cluckinjob:canPickUp', function(source, cb, items)
	local xPlayer = ESX.GetPlayerFromId(source)
	local result = false
	for i=1, #items, 1 do
...
RegisterServerEvent('esx_ava_cluckinjob:pickUp')
AddEventHandler('esx_ava_cluckinjob:pickUp', function(item)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_ava_cluckinjob:canprocess', function(source, cb, v)
...
RegisterServerEvent('esx_ava_cluckinjob:process')
AddEventHandler('esx_ava_cluckinjob:process', function(v)
...
RegisterServerEvent('esx_ava_cluckinjob:cancelProcessing')
AddEventHandler('esx_ava_cluckinjob:cancelProcessing', function()
...
RegisterNetEvent('esx_ava_cluckinjob:SellItems')
AddEventHandler('esx_ava_cluckinjob:SellItems', function(item,price,count) 
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_ava_cluckinjob:GetSellElements', function(source, cb, items) 
	local xPlayer = ESX.GetPlayerFromId(source)
	while not xPlayer do 
		xPlayer = ESX.GetPlayerFromId(source); 
		Citizen.Wait(0); 
...
RegisterNetEvent('esx_ava_cluckinjob:BuyItems')
AddEventHandler('esx_ava_cluckinjob:BuyItems', function(item,price,count) 
	local xPlayer = ESX.GetPlayerFromId(source)
	while not xPlayer do 
		xPlayer = ESX.GetPlayerFromId(source); 
		Citizen.Wait(0); 
...
ESX.RegisterServerCallback('esx_ava_cluckinjob:GetBuyElements', function(source, cb, items) 
	local xPlayer = ESX.GetPlayerFromId(source)
	while not xPlayer do 
		xPlayer = ESX.GetPlayerFromId(source); 
		Citizen.Wait(0); 
