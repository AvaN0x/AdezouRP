...
function RemoveItemsAfterRPDeath()
	...
	Citizen.CreateThread(function()
		...
		-- 	x = ESX.Math.Round(352.4, 1),
		-- 	y = ESX.Math.Round(-561.9, 1),
		-- 	z = ESX.Math.Round(29.2, 1)
		-- }
		local formattedCoords = {
			x = ESX.Math.Round(323.15, 1),
			y = ESX.Math.Round(-582.64, 1),
			z = ESX.Math.Round(42.3, 1)
		}
