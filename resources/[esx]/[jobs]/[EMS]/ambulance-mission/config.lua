...
Config.ActivationKeyText = 'INPUT_CELLPHONE_OPTION'

Config.InitialSeconds = 180
Config.MaxPatientsPerTrip = 3
Config.MaxLevels = 3

Config.Formulas = {
    moneyPerLevel               = function(level)                   return 160 * level * level end,
...
Config.Hospitals = {
    ...
    },
    {
        ...
        spawnPoints = {
            ...
            {x = -861.802, y = -233.739, z = 38.927},   {x = -634.887, y = -235.888, z = 37.262},
            {x = -708.851, y = -126.112, z = 37.083}
        }
    }
}
