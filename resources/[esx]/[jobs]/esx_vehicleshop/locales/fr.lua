Locales['fr'] = {
  ...
  ['vehicle_set_owned']               = 'le véhicule ~y~%s~s~ a été attribué à ~b~un citoyen~s~',
  ['vehicle_set_rented']              = 'le véhicule ~y~%s~s~ a été loué à ~b~un citoyen~s~',
  ['vehicle_sold_for']                = 'le ~b~%s~s~ a été ~y~vendu~s~ pour ~g~$%s~s~',
  ['vehicle_sold_to']                 = 'véhicule ~y~%s~s~ vendu à ~b~un citoyen~s~',
