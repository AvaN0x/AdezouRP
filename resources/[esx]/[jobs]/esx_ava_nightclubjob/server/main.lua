...
TriggerEvent('esx_phone:registerNumber', Config.JobName, _U('nightclub_client'), true, true)
...
RegisterServerEvent('esx_ava_nightclubjob:getStockItem')
AddEventHandler('esx_ava_nightclubjob:getStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('esx_ava_nightclubjob:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_ava_nightclubjob:putStockItems')
AddEventHandler('esx_ava_nightclubjob:putStockItems', function(itemName, count)
...
ESX.RegisterServerCallback('esx_ava_nightclubjob:getPlayerInventory', function(source, cb)
...
RegisterNetEvent('esx_ava_nightclubjob:BuyItems')
AddEventHandler('esx_ava_nightclubjob:BuyItems', function(item,price,count) 
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_ava_nightclubjob:GetBuyElements', function(source, cb, items) 
	local xPlayer = ESX.GetPlayerFromId(source)
	while not xPlayer do
		xPlayer = ESX.GetPlayerFromId(source);
		Citizen.Wait(0);
