...
RegisterNetEvent("mumble-voip:radioSpeak")
AddEventHandler("mumble-voip:radioSpeak", function()
	if mumbleConfig.radioEnabled then
		if playerRadio > 0 then
			local playerData = voiceData[playerServerId]
			SetVoiceData("radioActive", true)
...
RegisterNetEvent("mumble-voip:radioStopSpeak")
AddEventHandler("mumble-voip:radioStopSpeak", function()
